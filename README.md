# Face Recognition using Python face_recognition, asyncio websockets json and io to recognize the face take and to connect to the backend and get the real time results
